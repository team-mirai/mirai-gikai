...
- サービスタイトルおよび OGP タイトルは **「みらい議会＠地域名」** の形式にしてください
...
- **primary カラーにグリーン系（同系統を含む）は使用しないでください**
...
- サービス内に本家「みらい議会」へのリンクを掲載してください
  - リンク先: https://gikai.team-mir.ai/
- フッターや免責文言と合わせて表示することを推奨します
...
AGPL-3.0 が保証するソースコードの自由な利用・改変・再配布の権利は一切制限されません。本ガイドラインはあくまでブランドの混同を防ぐためのものです。
