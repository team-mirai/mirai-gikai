...
6. **message_to_politicians**: 元レポートの summary / opinions を根拠に、このペルソナが**今回の法案に関して政治家へ最終的に伝えたい核心メッセージ**を 2〜4 文でまとめてください。スタンスの結論 + 主な懸念/要望 + その根拠となる立場を含めること。シミュ後に「インタビューでこのメッセージが引き出せたか」を判定するので、**具体的で検証可能な内容**にしてください（抽象論だけにしない）。
