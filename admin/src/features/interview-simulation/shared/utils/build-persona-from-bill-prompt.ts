...
- **message_to_politicians**: このペルソナが今回の法案に関して政治家へ最終的に伝えたい核心メッセージを 2〜4 文で。スタンスの結論 + 主な懸念/要望 + その立場特有の根拠を含むこと。シミュ後に「インタビューでこれが引き出せたか」を判定するので、**具体的で検証可能な内容**にする（抽象論のみは避ける）。
