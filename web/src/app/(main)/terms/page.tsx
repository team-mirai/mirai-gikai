              ...
              },
              {
                ...
                content: (
                  <>
                    ...
                    本人が公開に同意しなかったインタビューデータについても、当組織内において、サービス向上、政策立案、不正対策その他当組織サービスの運営上必要な目的で利用するものとし、ユーザーはこれに同意するものとします。この場合でも、当該データが第三者に公開または提供されることはありません。
                  </>
                ),
              },
              {
                ...
                content: (
                  <>
                    ...
                    本サービスを通じて生成された応答や対話ログに関する権利（著作権法第27条および第28条の権利を含みます。）は、当組織に帰属するか、またはユーザーが当組織に対して無償で利用（複製、加工、公表等）することを許諾したものとみなします。なお、公表については、本条第1項のとおりユーザー本人が公表に同意した場合のみ実施するものとします。
                  </>
                ),
              },
            ]}
