      ...
      <Container className="space-y-10">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <LegalList
              items={[
                "個人情報の掲載：氏名、住所、電話番号、メールアドレス、SNS ID、口座番号、所属組織等、本人・他人を問わず特定の個人を識別できる情報の入力。",
              ...
              },
              {
                ...
                content: (
                  <>
                    ...
                    本サービスを通じて生成された応答や対話ログに関する権利（著作権法第27条および第28条の権利を含みます。）は、当組織に帰属するか、または無償で利用（複製、加工、公表等）することを許諾したものとみなします。
                  </>
                ),
              },
            ]}
