...
- レポートを提示し、ユーザーの確認を待つ場合: next_stage を "summary" にしてください
- ユーザーがレポート内容に同意し、完了すべきと判断した場合: next_stage を "summary_complete" にしてください
- ユーザーが明確にインタビューの再開や追加の質問への回答を希望した場合: next_stage を "chat" にしてください
